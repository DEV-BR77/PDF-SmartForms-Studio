...
|---|---|---|
| 0.1.0-alpha | Ready | Projektkern, CI, Konfiguration, PyQt6-Shell |
| 0.2.0-alpha | Planned | Profile, Validierung, flexible Felder |
| 0.3.0-alpha | Planned | Template-Schema, Import/Export |
| 0.4.0-alpha | Planned | PDF-Analyse und farbige Vorschau |
| 0.5.0-alpha | Planned | lernendes Feldlexikon |
